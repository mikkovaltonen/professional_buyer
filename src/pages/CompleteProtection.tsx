...
import { Shield, Umbrella, CheckCircle, ArrowLeft } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold mb-6">Complete Protection</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <Umbrella className="h-8 w-8 text-purple-600 mb-4" />
              <h3 className="text-xl font-semibold mb-3">Full Coverage</h3>
              <p className="text-gray-600">
                Get protection across all aspects of your life and business
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <p className="text-gray-600">
                Identify and fill any gaps in your current insurance coverage
              </p>
            </div>
          </div>
...
export default CompleteProtection;
